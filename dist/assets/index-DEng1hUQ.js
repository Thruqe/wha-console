(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[];function t(t,n){e.push({pattern:t,segments:t.split(`/`).filter(Boolean),handler:n})}function n(e){window.location.hash=e}function r(t){let n=t.split(`/`).filter(Boolean);for(let t of e){if(t.segments.length!==n.length)continue;let e={},r=!0;for(let i=0;i<t.segments.length;i++){let a=t.segments[i];if(a.startsWith(`:`))e[a.slice(1)]=n[i];else if(a!==n[i]){r=!1;break}}if(r)return{handler:t.handler,params:e}}return null}function i(){let t=r(window.location.hash.slice(1)||`/login`);t?t.handler(t.params):e.find(e=>e.pattern===`/404`)?.handler({})}function a(){window.addEventListener(`hashchange`,i),i()}function o(e){try{let t=e.split(`.`)[1],n=t.replace(/-/g,`+`).replace(/_/g,`/`).padEnd(t.length+(4-t.length%4)%4,`=`),r=JSON.parse(atob(n));return typeof r.exp==`number`?r.exp*1e3:null}catch{return null}}var s=`/api`,c=localStorage.getItem(`access_token`),l=c?o(c):null,u=0,d=3e5;function f(e){c=e,e?(localStorage.setItem(`access_token`,e),l=o(e)):(l=null,localStorage.removeItem(`access_token`))}function p(){return!!c&&!!l&&Date.now()<l}async function m(e,t={}){let n={"Content-Type":`application/json`,...t.headers};c&&(n.Authorization=`Bearer ${c}`);let r=await fetch(`${s}${e}`,{...t,headers:n,credentials:`include`}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(i.error||`Request failed: ${r.status}`);return i}async function ee(){try{let e=await fetch(`${s}/auth/refresh`,{method:`POST`,credentials:`include`});return e.ok?(f((await e.json()).access_token),!0):!1}catch{return!1}}async function h(){if(!(Date.now()-u>d)&&p())return!0;if(c)try{return await m(`/auth/me`),u=Date.now(),!0}catch{}return ee()}async function te(){try{await m(`/auth/logout`,{method:`POST`})}finally{f(null),u=0}}var g={signup:(e,t,n)=>m(`/auth/signup`,{method:`POST`,body:JSON.stringify({email:e,username:t,password:n})}),login:(e,t)=>m(`/auth/login`,{method:`POST`,body:JSON.stringify({email:e,username:e,password:t})}),listProcesses:()=>m(`/processes`),getProcess:e=>m(`/processes/${e}`)};function ne(e){return m(`/processes`,{method:`POST`,body:JSON.stringify(e)})}function re(e,t){return m(`/processes/${e}/settings`,{method:`PATCH`,body:JSON.stringify(t)})}function _(e){return m(`/processes/${e}`,{method:`DELETE`})}function ie(e){return m(`/processes/${e}/run`,{method:`POST`})}function ae(e){return m(`/processes/${e}/stop`,{method:`POST`})}function oe(e){return m(`/processes/${e}/logs/clear`,{method:`POST`})}function se(e){return m(`/processes/${e}/logout`,{method:`POST`})}function ce(){return m(`/limits`)}function le(e){return m(`/processes/${e}/waitlist`,{method:`DELETE`})}var ue={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":2,"stroke-linecap":`round`,"stroke-linejoin":`round`},de=([e,t,n])=>{let r=document.createElementNS(`http://www.w3.org/2000/svg`,e);return Object.keys(t).forEach(e=>{r.setAttribute(e,String(t[e]))}),n?.length&&n.forEach(e=>{let t=de(e);r.appendChild(t)}),r},fe=(e,t={})=>de([`svg`,{...ue,...t},e]),pe=[[`path`,{d:`M12 5v14`}],[`path`,{d:`m19 12-7 7-7-7`}]],v=[[`path`,{d:`m12 19-7-7 7-7`}],[`path`,{d:`M19 12H5`}]],me=[[`path`,{d:`M12 5v16`}],[`path`,{d:`M20.001 19A2 2 0 0022 17V5a2 2 0 00-1.999-2L16 3.002A5 5 0 0012 5a5 5 0 00-4-2H4a2 2 0 00-2 2v12a2 2 0 001.999 2H8a5 5 0 014 2 5 5 0 014-2z`}]],he=[[`path`,{d:`M5 21v-6`}],[`path`,{d:`M12 21V3`}],[`path`,{d:`M19 21V9`}]],ge=[[`path`,{d:`M20 6 9 17l-5-5`}]],y=[[`circle`,{cx:`12`,cy:`12`,r:`10`}],[`path`,{d:`M12 6v6l4 2`}]],b=[[`path`,{d:`m16 18 6-6-6-6`}],[`path`,{d:`m8 6-6 6 6 6`}]],x=[[`rect`,{width:`14`,height:`14`,x:`8`,y:`8`,rx:`2`,ry:`2`}],[`path`,{d:`M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2`}]],_e=[[`ellipse`,{cx:`12`,cy:`5`,rx:`9`,ry:`3`}],[`path`,{d:`M3 5V19A9 3 0 0 0 21 19V5`}],[`path`,{d:`M3 12A9 3 0 0 0 21 12`}]],ve=[[`path`,{d:`M12 15V3`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`}],[`path`,{d:`m7 10 5 5 5-5`}]],ye=[[`path`,{d:`M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49`}],[`path`,{d:`M14.084 14.158a3 3 0 0 1-4.242-4.242`}],[`path`,{d:`M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143`}],[`path`,{d:`m2 2 20 20`}]],be=[[`path`,{d:`M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0`}],[`circle`,{cx:`12`,cy:`12`,r:`3`}]],xe=[[`path`,{d:`M12 10a2 2 0 0 0-2 2c0 1.02-.1 2.51-.26 4`}],[`path`,{d:`M14 13.12c0 2.38 0 6.38-1 8.88`}],[`path`,{d:`M17.29 21.02c.12-.6.43-2.3.5-3.02`}],[`path`,{d:`M2 12a10 10 0 0 1 18-6`}],[`path`,{d:`M2 16h.01`}],[`path`,{d:`M21.8 16c.2-2 .131-5.354 0-6`}],[`path`,{d:`M5 19.5C5.5 18 6 15 6 12a6 6 0 0 1 .34-2`}],[`path`,{d:`M8.65 22c.21-.66.45-1.32.57-2`}],[`path`,{d:`M9 6.8a6 6 0 0 1 9 5.2v2`}]],S=[[`circle`,{cx:`12`,cy:`12`,r:`10`}],[`path`,{d:`M12 16v-4`}],[`path`,{d:`M12 8h.01`}]],Se=[[`path`,{d:`m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4`}],[`path`,{d:`m21 2-9.6 9.6`}],[`circle`,{cx:`7.5`,cy:`15.5`,r:`5.5`}]],C=[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`}]],w=[[`rect`,{width:`18`,height:`11`,x:`3`,y:`11`,rx:`2`,ry:`2`}],[`path`,{d:`M7 11V7a5 5 0 0 1 10 0v4`}]],T=[[`path`,{d:`m16 17 5-5-5-5`}],[`path`,{d:`M21 12H9`}],[`path`,{d:`M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4`}]],E=[[`path`,{d:`m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7`}],[`rect`,{x:`2`,y:`4`,width:`20`,height:`16`,rx:`2`}]],Ce=[[`path`,{d:`M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z`}]],we=[[`path`,{d:`M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384`}]],D=[[`path`,{d:`M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z`}]],O=[[`path`,{d:`M5 12h14`}],[`path`,{d:`M12 5v14`}]],Te=[[`rect`,{width:`5`,height:`5`,x:`3`,y:`3`,rx:`1`}],[`rect`,{width:`5`,height:`5`,x:`16`,y:`3`,rx:`1`}],[`rect`,{width:`5`,height:`5`,x:`3`,y:`16`,rx:`1`}],[`path`,{d:`M21 16h-3a2 2 0 0 0-2 2v3`}],[`path`,{d:`M21 21v.01`}],[`path`,{d:`M12 7v3a2 2 0 0 1-2 2H7`}],[`path`,{d:`M3 12h.01`}],[`path`,{d:`M12 3h.01`}],[`path`,{d:`M12 16v.01`}],[`path`,{d:`M16 12h1`}],[`path`,{d:`M21 12v.01`}],[`path`,{d:`M12 21v-1`}]],Ee=[[`path`,{d:`M16.247 7.761a6 6 0 0 1 0 8.478`}],[`path`,{d:`M19.075 4.933a10 10 0 0 1 0 14.134`}],[`path`,{d:`M4.925 19.067a10 10 0 0 1 0-14.134`}],[`path`,{d:`M7.753 16.239a6 6 0 0 1 0-8.478`}],[`circle`,{cx:`12`,cy:`12`,r:`2`}]],De=[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`}],[`path`,{d:`m21.854 2.147-10.94 10.939`}]],k=[[`rect`,{width:`20`,height:`8`,x:`2`,y:`2`,rx:`2`,ry:`2`}],[`rect`,{width:`20`,height:`8`,x:`2`,y:`14`,rx:`2`,ry:`2`}],[`line`,{x1:`6`,x2:`6.01`,y1:`6`,y2:`6`}],[`line`,{x1:`6`,x2:`6.01`,y1:`18`,y2:`18`}]],Oe=[[`path`,{d:`M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915`}],[`circle`,{cx:`12`,cy:`12`,r:`3`}]],A=[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`}],[`path`,{d:`m9 12 2 2 4-4`}]],ke=[[`path`,{d:`M10 8h4`}],[`path`,{d:`M12 21v-9`}],[`path`,{d:`M12 8V3`}],[`path`,{d:`M17 16h4`}],[`path`,{d:`M19 12V3`}],[`path`,{d:`M19 21v-5`}],[`path`,{d:`M3 14h4`}],[`path`,{d:`M5 10V3`}],[`path`,{d:`M5 21v-7`}]],Ae=[[`rect`,{width:`14`,height:`20`,x:`5`,y:`2`,rx:`2`,ry:`2`}],[`path`,{d:`M12 18h.01`}]],j=[[`rect`,{width:`18`,height:`18`,x:`3`,y:`3`,rx:`2`}]],M=[[`path`,{d:`M12 19h8`}],[`path`,{d:`m4 17 6-6-6-6`}]],je=[[`path`,{d:`m16 16-3 3 3 3`}],[`path`,{d:`M3 12h14.5a1 1 0 0 1 0 7H13`}],[`path`,{d:`M3 19h6`}],[`path`,{d:`M3 5h18`}]],N=[[`path`,{d:`M10 11v6`}],[`path`,{d:`M14 11v6`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`}],[`path`,{d:`M3 6h18`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`}]],Me=[[`path`,{d:`m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3`}],[`path`,{d:`M12 9v4`}],[`path`,{d:`M12 17h.01`}]],P=[[`path`,{d:`M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2`}],[`circle`,{cx:`12`,cy:`7`,r:`4`}]],F=[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`}],[`circle`,{cx:`9`,cy:`7`,r:`4`}]],I=[[`path`,{d:`M18 6 6 18`}],[`path`,{d:`m6 6 12 12`}]];function L(e,t={}){let n=fe(e);return n.setAttribute(`width`,String(t.size??20)),n.setAttribute(`height`,String(t.size??20)),t.class&&n.setAttribute(`class`,t.class),n.outerHTML}function Ne(){let e=document.getElementById(`app`),t=`login`,r=!1;function i(){e.innerHTML=`
      <div class="auth-wrapper">
        <div class="auth-content">
          <div class="auth-logo">${L(M,{size:22})} wha-console</div>
          ...
          <button type="button" id="passkey-btn" class="secondary">
            ${L(xe,{size:18})} Sign in with a passkey
          </button>
  ...
  <div class="input-icon-wrap">
    <span class="icon-left">${L(E,{size:16})}</span>
...
<div class="field">
  ...
  <div class="input-icon-wrap">
    <span class="icon-left">${L(w,{size:16})}</span>
    ...
    `,document.getElementById(`toggle-mode`).addEventListener(`click`,e=>{e.preventDefault(),t=t===`login`?`signup`:`login`,r=!1,i()}),document.getElementById(`toggle-password`).addEventListener(`click`,()=>{let e=document.getElementById(`password`),t=document.getElementById(`toggle-password`);r=!r,e.type=r?`text`:`password`,t.innerHTML=L(r?ye:be,{size:16})}),document.getElementById(`passkey-btn`).addEventListener(`click`,async()=>{let e=document.getElementById(`auth-error`);e.textContent=``;let t=prompt(`Enter your username to sign in with a passkey:`);if(t)try{await Pe(t),n(`/dashboard`)}catch(t){e.textContent=t.message}}),document.getElementById(`auth-form`).addEventListener(`submit`,async e=>{e.preventDefault();let r=document.getElementById(`auth-error`);r.textContent=``;let i=document.getElementById(`email`).value,a=document.getElementById(`password`).value;try{let e;if(t===`signup`){let t=document.getElementById(`username`).value;e=await g.signup(i,t,a),f(e.access_token),n(`/passkey-prompt`);return}e=await g.login(i,a),f(e.access_token),n(`/dashboard`),f(e.access_token),n(`/dashboard`)}catch(e){r.textContent=e.message}})}i()}async function Pe(e){let t=await fetch(`/api/webauthn/login/begin`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify({username:e})});if(!t.ok)throw Error(`No passkey found for this user`);let n=Ie((await t.json()).publicKey),r=await navigator.credentials.get({publicKey:n}),i=await fetch(`/api/webauthn/login/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify(Le(r))});if(!i.ok)throw Error(`Passkey authentication failed`);f((await i.json()).access_token)}function Fe(e){let t=e.replace(/-/g,`+`).replace(/_/g,`/`).padEnd(e.length+(4-e.length%4)%4,`=`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function R(e){let t=new Uint8Array(e),n=``;return t.forEach(e=>n+=String.fromCharCode(e)),btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=+$/,``)}function Ie(e){return{...e,challenge:Fe(e.challenge),allowCredentials:e.allowCredentials?.map(e=>({...e,id:Fe(e.id)}))}}function Le(e){let t=e.response;return{id:e.id,rawId:R(e.rawId),type:e.type,response:{authenticatorData:R(t.authenticatorData),clientDataJSON:R(t.clientDataJSON),signature:R(t.signature),userHandle:t.userHandle?R(t.userHandle):null}}}function z(e,t){let n=document.createElement(`div`);n.className=`modal-overlay`,n.innerHTML=`<div class="modal">${e}</div>`,document.body.appendChild(n);function r(){n.remove(),document.removeEventListener(`keydown`,i),t?.()}function i(e){e.key===`Escape`&&r()}return n.addEventListener(`click`,e=>{e.target===n&&r()}),document.addEventListener(`keydown`,i),n.__close=r,n}function B(e){e.__close?.()}function V(e,t=`error`){let n=document.createElement(`div`);n.className=`toast toast-${t}`,n.textContent=e,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`visible`)),setTimeout(()=>{n.classList.remove(`visible`),setTimeout(()=>n.remove(),200)},3500)}function H(e){let t=z(`
    <div class="modal-header">
      <h2>Create New Process</h2>
      <button type="button" class="modal-close" id="modal-close-btn">${L(I,{size:18})}</button>
    </div>
    <form id="process-form">
      <div class="modal-body">
        ...
        <div class="field">
          ...
          <div class="radio-group">
            <div class="radio-option">
              ...
              <label for="auth-pair">${L(Ae,{size:15})} Pair Code</label>
            </div>
            <div class="radio-option">
              <input type="radio" name="auth-type" id="auth-qr" value="qr" />
              <label for="auth-qr">${L(Te,{size:15})} QR Code</label>
            </div>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="input-icon-wrap">
            <span class="icon-left">${L(_e,{size:16})}</span>
  ...
  `);document.getElementById(`modal-close-btn`).addEventListener(`click`,()=>B(t)),document.getElementById(`modal-cancel-btn`).addEventListener(`click`,()=>B(t)),document.getElementById(`process-form`).addEventListener(`submit`,async n=>{n.preventDefault();let r=document.getElementById(`process-form-error`),i=document.getElementById(`proc-submit-btn`);r.textContent=``,i.disabled=!0;let a=document.getElementById(`proc-name`).value,o=document.getElementById(`proc-phone`).value,s=document.querySelector(`input[name="auth-type"]:checked`).value,c=document.querySelector(`input[name="client"]:checked`).value,l=document.getElementById(`proc-db`).value;try{await ne({name:a,phone_number:o,auth_type:s,client:c,database_url:l}),B(t),V(`Process "${a}" created successfully`,`success`),e()}catch(e){r.textContent=e.message,i.disabled=!1}})}function Re(){let e=z(`
    <div class="modal-header">
      ...
      <button type="button" class="modal-close" id="about-modal-close-btn">${L(I,{size:18})}</button>
    </div>
    
    <div class="modal-body about-modal-body">
      <!-- Section 1: Engine Overview -->
      <div class="about-card">
        <div class="about-card-title">${L(M,{size:16})} Engine Overview</div>
        ...
        <div class="about-badge-grid">
          <span class="tech-badge">${L(b,{size:12})} Go 1.22+ & Echo</span>
          <span class="tech-badge">${L(Ee,{size:12})} Binary Protobuf WS</span>
          <span class="tech-badge">${L(_e,{size:12})} PostgreSQL & Redis</span>
          <span class="tech-badge">${L(A,{size:12})} WebAuthn / Passkeys</span>
        </div>
      </div>

      <!-- Section 2: Architecture & Capabilities -->
      <div class="about-card">
        <div class="about-card-title">${L(A,{size:16})} Console Capabilities</div>
  ...
  `);document.getElementById(`about-modal-close-btn`)?.addEventListener(`click`,()=>B(e)),document.getElementById(`about-modal-ok-btn`)?.addEventListener(`click`,()=>B(e))}var ze=`wha_cookie_preferences`;function U(){try{let e=localStorage.getItem(ze);if(e){let t=JSON.parse(e);return{essential:!0,analytics:!!t.analytics,functional:!!t.functional,consentId:t.consentId||G(),hasChoice:!0}}}catch{}return{essential:!0,analytics:!1,functional:!1,consentId:G(),hasChoice:!1}}async function W(e,t){let n=G(),r={essential:!0,analytics:e,functional:t,consentId:n,hasChoice:!0};try{localStorage.setItem(ze,JSON.stringify(r))}catch{}try{await fetch(`/api/cookies/preference`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify({consent_id:n,essential:!0,analytics:e,functional:t,marketing:!1})})}catch(e){console.warn(`Failed to sync cookie preferences with server:`,e)}return r}function G(){let e=``;try{e=localStorage.getItem(`wha_consent_id`)||``}catch{}if(!e){e=`c_`+Math.random().toString(36).substring(2,11)+Date.now().toString(36);try{localStorage.setItem(`wha_consent_id`,e)}catch{}}return e}async function K(e,t,n={}){let r=U();if(r.analytics)try{await fetch(`/api/telemetry/event`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify({consent_id:r.consentId,event_type:e,event_name:t,page_url:window.location.href,metadata:n})})}catch{}}function Be(){if(U().hasChoice)return;let e=document.createElement(`div`);e.className=`cookie-banner`,e.id=`cookie-banner-wrap`,e.innerHTML=`
    <div class="cookie-banner-content">
      <div class="cookie-banner-icon">${L(A,{size:24})}</div>
  ...
  `,document.body.appendChild(e),document.getElementById(`cookie-accept-all-btn`)?.addEventListener(`click`,async()=>{await W(!0,!0),e.remove(),V(`Preferences saved: Analytics & Telemetry enabled`,`success`),K(`consent_given`,`accept_all`)}),document.getElementById(`cookie-essential-btn`)?.addEventListener(`click`,async()=>{await W(!1,!1),e.remove(),V(`Preferences saved: Essential cookies only`,`success`)}),document.getElementById(`cookie-customize-btn`)?.addEventListener(`click`,()=>{e.remove(),Ve()})}function Ve(){let e=U(),t=z(`
    <div class="modal-header">
      ...
      <button type="button" class="modal-close" id="cookie-modal-close">${L(I,{size:18})}</button>
    </div>
  ...
  `);document.getElementById(`cookie-modal-close`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`cookie-modal-cancel`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`cookie-modal-save`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`pref-analytics`).checked,n=document.getElementById(`pref-functional`).checked;await W(e,n),B(t),V(`Cookie preferences updated`,`success`),e&&K(`consent_updated`,`analytics_enabled`)})}async function He(){let e={username:``,email:``,user_id:``};try{let t=await fetch(`/api/auth/me`,{headers:{Authorization:`Bearer ${localStorage.getItem(`access_token`)}`}});t.ok&&(e=await t.json())}catch{}let t=z(`
    <div class="modal-header">
      ...
      <button type="button" class="modal-close" id="user-modal-close">${L(I,{size:18})}</button>
    </div>
    ...
    <form id="user-profile-form">
      <div class="modal-body">
        <div class="field">
          ...
          <div class="input-icon-wrap">
            <span class="icon-left">${L(P,{size:16})}</span>
  ...
  `,document.getElementById(`api-docs-btn`).addEventListener(`click`,()=>{n(`/api-docs`)}),document.getElementById(`user-settings-btn`).addEventListener(`click`,()=>{He()}),document.getElementById(`cookie-pref-btn`).addEventListener(`click`,()=>{Ve()}),document.getElementById(`about-btn`).addEventListener(`click`,()=>{Re()}),document.getElementById(`logout-btn`).addEventListener(`click`,async()=>{await te(),n(`/login`)}),document.getElementById(`new-process-btn`).addEventListener(`click`,()=>{H(()=>X())}),document.getElementById(`empty-new-process-btn`)?.addEventListener(`click`,()=>{H(()=>X())}),t.forEach(e=>{document.querySelector(`.process-card[data-id="${e.id}"]`)?.addEventListener(`click`,()=>n(`/processes/${e.id}`)),document.getElementById(`start-${e.id}`)?.addEventListener(`click`,async t=>{t.stopPropagation();let n=t.currentTarget;n.disabled=!0;try{await ie(String(e.id)),V(`Process started`,`success`),X()}catch(e){let t=e.message;V(t,`error`),n.disabled=!1,X()}}),document.getElementById(`cancel-waitlist-${e.id}`)?.addEventListener(`click`,async t=>{t.stopPropagation();let n=t.currentTarget;n.disabled=!0;try{await le(String(e.id)),V(`Removed from waitlist`,`info`),X()}catch(e){V(e.message,`error`),n.disabled=!1}}),document.getElementById(`stop-${e.id}`)?.addEventListener(`click`,async t=>{t.stopPropagation();let n=t.currentTarget;n.disabled=!0;try{await ae(String(e.id)),X()}catch(e){V(e.message,`error`),n.disabled=!1}}),document.getElementById(`delete-${e.id}`)?.addEventListener(`click`,async t=>{t.stopPropagation();try{if(!await Y({title:`Delete process`,message:`Delete "${e.name}"? This cannot be undone.`,confirmLabel:`Delete`,danger:!0}))return;let t=J(`Deleting session…`);try{await _(String(e.id)),t(),X()}catch(e){t(),V(e.message,`error`)}}catch(e){console.error(`delete flow crashed:`,e)}})})}function Ue(e){let t=(e.used_ram_mb/1024).toFixed(1),n=(e.total_ram_mb/1024).toFixed(1),r=e.available_ram_mb;return`
  ...
  `}function We(){return`
    <div class="empty-state">
      <div class="icon-wrap">${L(k,{size:28})}</div>
  ...
  `}function Ke(e){let t=e.status===`queued`,n=t&&e.waitlist_position?`Queued #${e.waitlist_position}`:e.status;return`
    <div class="process-card ${t?`card-queued`:``}" data-id="${e.id}" style="cursor: pointer;">
      <div class="process-card-header">
        <div class="process-name">${L(k,{size:16})} ${e.name}</div>
        <span class="status-pill ${e.status}">${n}</span>
      </div>
      <div class="process-meta">${e.phone_masked} · ${e.client}</div>
      <div class="process-actions">
        ${e.status===`running`?`<button id="stop-${e.id}">${L(j,{size:14})} Stop</button>`:t?`<button id="cancel-waitlist-${e.id}" class="btn-warning">${L(y,{size:14})} Leave Queue</button>`:`<button id="start-${e.id}">${L(D,{size:14})} Start</button>`}
        <button id="delete-${e.id}">${L(N,{size:14})} Delete</button>
      </div>
    </div>
  `}function Z(e){let t=e.replace(/-/g,`+`).replace(/_/g,`/`).padEnd(e.length+(4-e.length%4)%4,`=`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function Q(e){let t=new Uint8Array(e),n=``;return t.forEach(e=>n+=String.fromCharCode(e)),btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=+$/,``)}async function qe(){let e=await fetch(`/api/webauthn/register/begin`,{method:`POST`,credentials:`include`,headers:{Authorization:`Bearer ${localStorage.getItem(`access_token`)}`}});if(!e.ok)throw Error(`Could not start passkey registration`);let t=await e.json(),n={...t.publicKey,challenge:Z(t.publicKey.challenge),user:{...t.publicKey.user,id:Z(t.publicKey.user.id)},excludeCredentials:t.publicKey.excludeCredentials?.map(e=>({...e,id:Z(e.id)}))},r=await navigator.credentials.create({publicKey:n});if(!r)throw Error(`Passkey creation was cancelled`);let i=r.response;if(!(await fetch(`/api/webauthn/register/finish`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${localStorage.getItem(`access_token`)}`},credentials:`include`,body:JSON.stringify({id:r.id,rawId:Q(r.rawId),type:r.type,response:{attestationObject:Q(i.attestationObject),clientDataJSON:Q(i.clientDataJSON)}})})).ok)throw Error(`Failed to save passkey`)}function Je(){let e=document.getElementById(`app`);e.innerHTML=`
    <div class="auth-wrapper">
      <div class="auth-content">
        <div class="auth-logo">${L(xe,{size:22})} wha-console</div>
  ...
  `,document.getElementById(`add-passkey`).addEventListener(`click`,async()=>{let e=document.getElementById(`passkey-error`);e.textContent=``;try{await qe(),n(`/dashboard`)}catch(t){e.textContent=t.message}}),document.getElementById(`skip-passkey`).addEventListener(`click`,()=>{n(`/dashboard`)})}function Ye(){let e=document.getElementById(`app`);e.innerHTML=`
    <div class="notfound-wrapper">
      <div class="notfound-content">
        <div class="notfound-code">${L(Me,{size:16})} Error 404</div>
        ...
        <div class="notfound-actions">
          <button type="button" class="primary" id="go-home">
            ${L(v,{size:16})} Back to console
          </button>
        </div>
      </div>
    </div>
  `,document.getElementById(`go-home`).addEventListener(`click`,()=>{n(`/dashboard`)})}function Xe(e=[]){let t=e.length>0,n=z(`
    <div class="modal-header">
      <div style="display: flex; align-items: center; gap: 10px;">
        ${L(F,{size:20})}
        <div>
      ...
      <button type="button" class="modal-close" id="groups-modal-close">${L(I,{size:18})}</button>
    </div>
  ...
  `);document.getElementById(`groups-modal-close`)?.addEventListener(`click`,()=>B(n)),document.getElementById(`groups-modal-ok`)?.addEventListener(`click`,()=>B(n)),e.forEach((e,t)=>{document.getElementById(`group-info-btn-${t}`)?.addEventListener(`click`,()=>{Ze(e)})})}function Ze(e){let t=z(`
    <div class="modal-header">
      <div style="display: flex; align-items: center; gap: 10px;">
        ${L(F,{size:20})}
        <div>
      ...
      <button type="button" class="modal-close" id="group-detail-close">${L(I,{size:18})}</button>
    </div>
      ...
      <div class="info-rows-list">
        ...
        <div class="info-row">
          ...
          <span class="info-row-value" style="font-family: var(--mono); font-size: 12px; display: flex; align-items: center; gap: 6px;">
            ${e.jid}
            <button type="button" class="icon-btn-sm" id="copy-group-jid" title="Copy JID">${L(x,{size:12})}</button>
          </span>
        </div>
        <div class="info-row">
  ...
  `);document.getElementById(`group-detail-close`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`group-detail-ok`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`copy-group-jid`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(e.jid).then(()=>{V(`Group JID copied to clipboard`,`success`)})})}function Qe(e=[]){let t=e.length>0,n=z(`
    <div class="modal-header">
      ...
      <button type="button" class="modal-close" id="contacts-modal-close">${L(I,{size:18})}</button>
    </div>
  ...
  `);document.getElementById(`contacts-modal-close`)?.addEventListener(`click`,()=>B(n)),document.getElementById(`contacts-modal-ok`)?.addEventListener(`click`,()=>B(n)),e.forEach((e,t)=>{document.getElementById(`contact-info-btn-${t}`)?.addEventListener(`click`,()=>{$e(e)})})}function $e(e){let t=z(`
    <div class="modal-header">
      <div style="display: flex; align-items: center; gap: 10px;">
        ${L(P,{size:20})}
        <div>
      ...
      <button type="button" class="modal-close" id="contact-detail-close">${L(I,{size:18})}</button>
    </div>
    ...
    <div class="modal-body">
      <div class="info-rows-list">
        ...
        <div class="info-row">
          ...
          <span class="info-row-value" style="font-family: var(--mono); font-size: 12px; display: flex; align-items: center; gap: 6px;">
            ${e.jid}
            <button type="button" class="icon-btn-sm" id="copy-contact-jid" title="Copy JID">${L(x,{size:12})}</button>
          </span>
        </div>
        <div class="info-row">
  ...
  `);document.getElementById(`contact-detail-close`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`contact-detail-ok`)?.addEventListener(`click`,()=>B(t)),document.getElementById(`copy-contact-jid`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(e.jid).then(()=>{V(`Contact JID copied to clipboard`,`success`)})})}function et(e=[]){let t=e.length>0,n=z(`
    <div class="modal-header">
      ...
      <button type="button" class="modal-close" id="communities-modal-close">${L(I,{size:18})}</button>
    </div>
  ...
  `);document.getElementById(`communities-modal-close`)?.addEventListener(`click`,()=>B(n)),document.getElementById(`communities-modal-ok`)?.addEventListener(`click`,()=>B(n)),e.forEach((e,t)=>{document.getElementById(`community-info-btn-${t}`)?.addEventListener(`click`,()=>{tt(e)})})}function tt(e){let t=z(`
    <div class="modal-header">
      <div style="display: flex; align-items: center; gap: 10px;">
        ${L(C,{size:20})}
        <div>
      ...
      <button type="button" class="modal-close" id="community-detail-close">${L(I,{size:18})}</button>
    </div>
    ...
    <div class="modal-body">
      <div class="info-rows-list">
        ...
        <div class="info-row">
          ...
          <span class="info-row-value" style="font-family: var(--mono); font-size: 12px; display: flex; align-items: center; gap: 6px;">
            ${e.jid}
            <button type="button" class="icon-btn-sm" id="copy-community-jid" title="Copy JID">${L(x,{size:12})}</button>
          </span>
        </div>
        <div class="info-row">
...
`))if(t.startsWith(`data: `))try{let e=JSON.parse(t.slice(6));e.text&&rt(e.text)}catch{rt(t.slice(6))}}}}catch(e){e.name!==`AbortError`&&console.error(`Log stream error:`,e)}}).catch(()=>{})}async function d(){try{let e=await fetch(`/api/processes/${r.id}/stats`,{headers:{Authorization:`Bearer ${localStorage.getItem(`access_token`)}`}});e.ok&&(o=await e.json())}catch{}}async function f(){t.innerHTML=`
      <div class="dash-wrapper">
        <div class="detail-header">
          <button type="button" class="detail-back" id="back-btn" title="Back to processes">${L(v,{size:18})}</button>
          <div class="detail-title">${L(k,{size:18})} ${r.name}</div>
          <span class="status-pill ${r.status}">
            ${r.status===`queued`&&r.waitlist_position?`Queued #${r.waitlist_position}`:r.status}
          </span>
          <div style="margin-left: auto; display: flex; gap: 8px;">
            ${r.status===`running`?`<button type="button" class="outline" id="detail-stop-btn">${L(j,{size:14})} Stop</button>`:r.status===`queued`?`<button type="button" class="outline btn-warning" id="detail-cancel-waitlist-btn">${L(y,{size:14})} Leave Queue</button>`:`<button type="button" class="outline" id="detail-start-btn">${L(D,{size:14})} Start</button>`}
          </div>
        </div>
    ...
    <div class="about-bot-container">
      ...
      <div class="bot-profile-card">
        ...
        <div class="bot-profile-info">
          ...
          <div class="bot-identity-pills">
            <span class="id-pill">
              ${L(we,{size:13})} ${e.phone_number}
              <button type="button" class="icon-btn-sm" id="copy-pn-btn" title="Copy Phone Number">${L(x,{size:12})}</button>
            </span>
            <span class="id-pill">
              <strong>JID:</strong> ${a}
              <button type="button" class="icon-btn-sm" id="copy-jid-btn" title="Copy JID">${L(x,{size:12})}</button>
            </span>
            <span class="id-pill">
              <strong>LID:</strong> ${o}
              <button type="button" class="icon-btn-sm" id="copy-lid-btn" title="Copy LID">${L(x,{size:12})}</button>
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="bot-stats-grid">
        ...
        <div class="stat-card clickable-stat" id="stat-card-groups" style="cursor: pointer;" title="Click to view joined groups">
          ...
          ${L(S,{size:14,class:`stat-info-icon`})}
        </div>
        ...
        <div class="settings-card danger-card">
          ...
          ${e.has_run_before?`
            <div class="danger-block">
              ...
              <button type="button" class="outline" id="logout-session-btn" ${e.status===`logged_out`?`disabled`:``}>
                ${L(T,{size:14})} ${e.status===`logged_out`?`Logged out`:`Log out session`}
              </button>
            </div>`:``}
          ...
          <div class="danger-block" style="border-top: 1px solid var(--border); margin-top: 16px; padding-top: 16px;">
            ...
            <button type="button" class="danger" id="delete-process-btn" ${t?``:`disabled`}>
              ${L(N,{size:14})} Delete process
            </button>
          </div>
        </div>
      </div>
    </div>
  `}function ut(e,t){document.getElementById(`verbose-toggle`)?.addEventListener(`change`,async n=>{let r=n.target,i=r.checked;try{let n=await re(String(e.id),{verbose:i});e.verbose=i,n.restarted?V(`Setting saved — process restarted`,`success`):n.warning?V(n.warning,`error`):V(`Verbose setting updated`,`success`),t()}catch(e){r.checked=!i,V(e.message,`error`)}}),document.getElementById(`skip-old-toggle`)?.addEventListener(`change`,async n=>{let r=n.target,i=r.checked,a=!i;try{let n=await re(String(e.id),{no_skip_old:a});e.no_skip_old=a,n.restarted?V(`Setting saved — process restarted`,`success`):n.warning?V(n.warning,`error`):V(`Offline messages setting updated`,`success`),t()}catch(e){r.checked=!i,V(e.message,`error`)}}),document.getElementById(`logout-session-btn`)?.addEventListener(`click`,async()=>{if(!await Y({title:`Log out session`,message:`This will stop "${e.name}" if running, and execute whatsrook -l to log out of WhatsApp. Continue?`,confirmLabel:`Log out`,danger:!0}))return;let n=J(`Logging out session…`);try{await se(String(e.id)),n(),e.status=`logged_out`,t()}catch(e){n(),V(e.message,`error`)}}),document.getElementById(`delete-process-btn`)?.addEventListener(`click`,async()=>{if(!await Y({title:`Delete process`,message:`Delete "${e.name}"? This cannot be undone.`,confirmLabel:`Delete`,danger:!0}))return;let t=J(`Deleting session…`);try{await _(String(e.id)),t(),n(`/dashboard`)}catch(e){t(),V(e.message,`error`)}})}async function $(){if(!await h()){n(`/login`);return}let e=document.getElementById(`app`);e.innerHTML=`<div class="dash-wrapper"><div class="dash-main">${q(`Loading API key manager...`)}</div></div>`;let t=[];try{let e=await fetch(`/api/keys`,{headers:{Authorization:`Bearer ${localStorage.getItem(`access_token`)}`}});e.ok&&(t=await e.json())}catch{}e.innerHTML=`
    <div class="dash-wrapper">
      <div class="dash-header">
        <button type="button" class="detail-back" id="api-back-btn" title="Back to Dashboard">
          ${L(v,{size:18})}
        </button>
        <div class="dash-logo">${L(b,{size:20})} API Keys & Integration Docs</div>
      </div>
      ...
      <div class="dash-main" style="max-width: 1100px; margin: 0 auto;">
        ...
        <div class="about-hero-card" style="margin-bottom: 24px;">
          <div class="about-hero-header">
            <div class="about-hero-icon">${L(Se,{size:24})}</div>
            <div>
  ...
  `,document.getElementById(`api-back-btn`).addEventListener(`click`,()=>n(`/dashboard`)),document.getElementById(`create-key-form`)?.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`key-name`).value;try{let e=await fetch(`/api/keys`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${localStorage.getItem(`access_token`)}`},body:JSON.stringify({name:t})});if(!e.ok)throw Error(`Failed to generate API key`);V(`API Key "${(await e.json()).name}" generated!`,`success`),$()}catch(e){V(e.message,`error`)}}),t.forEach(e=>{document.getElementById(`copy-key-${e.id}`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(e.key).then(()=>{V(`API Key copied to clipboard`,`success`)})}),document.getElementById(`revoke-key-${e.id}`)?.addEventListener(`click`,async()=>{if(confirm(`Revoke API key "${e.name}"?`))try{if(!(await fetch(`/api/keys/${e.id}`,{method:`DELETE`,headers:{Authorization:`Bearer ${localStorage.getItem(`access_token`)}`}})).ok)throw Error(`Failed to revoke key`);V(`API key revoked`,`success`),$()}catch(e){V(e.message,`error`)}})})}function dt(e){let t=e.key.substring(0,12)+`...`+e.key.substring(e.key.length-4),n=e.last_used_at?new Date(e.last_used_at).toLocaleString():`Never`;return`
    <div style="border-bottom: 1px solid var(--border); padding: 14px 0;">
      ...
      <button type="button" class="danger" id="revoke-key-${e.id}" style="padding: 5px 10px; font-size: 12px;">
        ${L(N,{size:12})} Revoke Key
      </button>
    </div>
  `}t(`/login`,Ne),t(`/dashboard`,X),t(`/passkey-prompt`,Je),t(`/processes/:id`,nt),t(`/api-docs`,$),t(`/404`,Ye);async function ft(){Be();let e=await h(),t=window.location.hash.slice(1);e&&(t===``||t===`/login`)&&n(`/dashboard`),!e&&t===`/dashboard`&&n(`/login`),a(),K(`page_view`,t||`login`)}ft();